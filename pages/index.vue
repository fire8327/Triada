    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="flex max-lg:flex-col gap-6">
            ...
            <div class="flex flex-col gap-4 w-full lg:w-1/2">
                <p>
                    <span class="text-red-500 text-2xl">Triada</span> — рекламное агентство полного цикла. Мы создаём эффективные стратегии, которые помогают бизнесу расти и выделяться. Индивидуальный подход, креатив и инновации — наши главные принципы.
                </p>
